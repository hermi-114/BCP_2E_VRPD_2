...
public class ARCCut implements ICut {
    ...
    public ARCCut(Set<Integer> C) {
        ...
        this.k   = (int) Math.floor((double) Constant.TRUCK_PAYLOAD
                                   / Constant.DRONE_AND_EQUIPMENT_WEIGHT);
        this.rhs = (int) Math.ceil(totalDemand / Constant.DRONE_AND_EQUIPMENT_WEIGHT
                                  - Constant.EPSILON);
    }
